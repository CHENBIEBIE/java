...
<div class="navbar navbar-static-top">
    <div class="navbar-inner">
        <a class="brand" href="/home">凯盛医疗</a>
        <ul class="nav">
            <li class="active"><a href="/user/home"><i class="fa fa-home"></i> 首页</a></li>
            <li><a href="/patient/home"><i class="fa fa-building"></i> 病人档案</a></li>
            ...
            <li class="dropdown">
                ...
                <ul class="dropdown-menu">
                    <li><a href="/install/list"><i class="fa fa-sitemap"></i> 科室设置</a></li>
                    <li><a href="/install/disease"><i class="fa fa-medkit"></i> 病种设置</a></li>
